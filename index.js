...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
//An inner function is simply a function that is defined inside another function. The inner function is able to access the variables that have been defined within the scope of the outer function, but it cannot change them. ... For instance, an inner function is protected from what happens outside it.
...
function lowerCaseNames(array) {
 let lowerCase = array.map((array)=>{
   return array.animal_name.toLowerCase();
...
function lowPopulationAnimals(array) {
  let lowPopulation = array.filter((array)=>{
...
function USApop(array) {
  let totalPop = array.reduce((accumulator,array)=>{
    return accumulator + array.population;
  },0);
  return totalPop
}
